...
type Settings struct {
	...
	VisitorNotificationEnabled         bool   `json:"visitor_notification_enabled" default:"false"`
	VisitorNotificationCooldownMinutes int    `json:"visitor_notification_cooldown_minutes" default:"1440"`
	VisitorNotificationWhitelist       string `json:"visitor_notification_whitelist" default:""`
	VisitorIPBlocklist                 string `json:"visitor_ip_blocklist" default:""`
...
const (
	...
	VisitorNotificationEnabledKey         = "visitor_notification_enabled"
	VisitorNotificationCooldownMinutesKey = "visitor_notification_cooldown_minutes"
	VisitorNotificationWhitelistKey       = "visitor_notification_whitelist"
	VisitorIPBlocklistKey                 = "visitor_ip_blocklist"
